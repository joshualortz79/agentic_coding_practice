...
const RAW_DATA = [
  ...
  { name: "AskData - Audience Discovery (P2)", capability: "Segmentation", valueDriver: "Opportunity Mapping", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "AskAudience - Audience Segmentation GenAI (Prod)", capability: "Segmentation", valueDriver: "Opportunity Mapping", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "High-Intent False Reds Fix", capability: "Data Correction", valueDriver: "Insight Generation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Social Media Feedback Loop", capability: "Sentiment Analysis", valueDriver: "Insight Generation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "AskRetail - Deep Customer Insights (DCI)", capability: "Search & Retrieval (RAG)", valueDriver: "Insight Generation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Insightful Search (Strativio 2025)", capability: "Search & Retrieval (RAG)", valueDriver: "Insight Generation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Enable Cludo AI Summary", capability: "Search & Retrieval (RAG)", valueDriver: "Insight Generation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Audience StartRight", capability: "Segmentation", valueDriver: "Opportunity Mapping", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "1876 - Content Generation (Phase 2)", capability: "Content Creation", valueDriver: "Plan Implementation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "1876 - Content Generation (Phase 3)", capability: "Content Creation", valueDriver: "Plan Implementation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "New Content Generation Solution", capability: "Content Creation", valueDriver: "Plan Implementation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Digital - Spanish Translation", capability: "Translation/Transcription", valueDriver: "Plan Implementation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Paid Media Optimization via Claritas MMA (+PILOT)", capability: "Audience Optimization", valueDriver: "In-Market Optimization", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Customized Product Offerings (Designed by Dad)", capability: "Offer Presentment", valueDriver: "In-Market Optimization", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Accessory Promotion Recommender", capability: "Recommendation Engine", valueDriver: "In-Market Optimization", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Accessory Recommender", capability: "Recommendation Engine", valueDriver: "In-Market Optimization", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "AI Decisioning Tool", capability: "Workflow Automation", valueDriver: "Plan Implementation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Moving/Switcher Wizard (Bill Screenshot)", capability: "Image/Video Analysis", valueDriver: "Plan Implementation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Personalization Agentic AI", capability: "Personalization", valueDriver: "In-Market Optimization", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Wake Up With Craig (AT&T Small Business)", capability: "Digital Engagement", valueDriver: "Plan Implementation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Idealab AI Agent", capability: "Knowledge Base / Q&A", valueDriver: "Plan Implementation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Google AI-Max for Paid Search", capability: "Audience Optimization", valueDriver: "In-Market Optimization", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "UC 300 - The Nudge: Real-Time Call Offers", capability: "Voice/Speech Recognition", valueDriver: "In-Market Optimization", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Real-Time Call Offers - Mobility", capability: "Recommendation Engine", valueDriver: "In-Market Optimization", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Use Case 89 - AI Brief Builder (Production)", capability: "Workflow Automation", valueDriver: "Plan Implementation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Video Editing Efficiencies (DaVinci)", capability: "Content Creation", valueDriver: "Plan Implementation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Generate Metadata (Products/Pages)", capability: "Content Creation", valueDriver: "Plan Implementation", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "AI-Prompted Exclusive Offers", capability: "Offer Presentment", valueDriver: "In-Market Optimization", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "AskData / Ask Databases - Campaign Evaluation (P2)", capability: "Data Analysis", valueDriver: "Performance Intelligence", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Abandonment & Progression Analysis (High-Intent)", capability: "Prediction/Forecasting", valueDriver: "Performance Intelligence", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Neurons - Creative Evaluation Tool", capability: "Image/Video Analysis", valueDriver: "Performance Intelligence", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Digital Experimentation Archive & Decisioning", capability: "Knowledge Base / Q&A", valueDriver: "Performance Intelligence", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Use-Case Deduplication & Similarity Detection", capability: "Data Flagging", valueDriver: "Performance Intelligence", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Use Case 89 - AI Brief Builder (Design)", capability: "Document Generation", valueDriver: "Integrated Planning", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
{ name: "Blueprint Booster", capability: "Knowledge Base / Q&A", valueDriver: "Brand and Growth Strategy", benefits: 1000000, lifecycle: "Discovery", risk: "Risk Unknown", effort: "Low" },
        ...
        <div className="flex-1">
          <div className="rounded-2xl border border-slate-200 shadow-sm bg-white">
            <div className="px-5 pt-4 pb-2">
              ...
              <p className="text-sm text-slate-600">X: Capability Type • Y: Value Driver • Size: Benefits ($) • Opacity: Benefits • Color: Risk • Symbol: Level of Effort (◯/◐/●)</p>
            </div>
            ...
            <div ref={containerRef} className="px-2 pb-2 overflow-x-auto">
              <svg ref={svgRef} width={svgW} height={height} className="overflow-visible">
                ...
                <g transform={`translate(${M.left},${M.top})`}>
                  ...
                  {/* Points — symbol overlay for Effort; bubble fill = Risk; opacity = Benefits; size = Benefits
                      NOTE: we now use jittered list to avoid direct overlaps */}
